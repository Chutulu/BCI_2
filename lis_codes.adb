package body LIS_Codes is

   LIS_Codes_Class : constant String := "LIS_Codes_Class";
   Liste_Of_LIS_Codes_Class: constant String := "List of LIS Codes";
